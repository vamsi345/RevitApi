...

{
    ...
    public class WallCutDimension : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            //List<Line> Dlines2 = DimensionLines(elementIds, 25);
            //List<Line> Dlines3 = DimensionLines(elementIds, 15);
            //List<Line> Dlines4 = DimensionLines(elementIds, 5);
            ...
            foreach (List<Wall> walls in AllWalls)
            {
                ...
                foreach (Wall lwall in walls)
                {
                    ...
                    foreach (ElementId AllWall in eleIds)
                    {
                        ...
                        {
                            float l11 = (float)line1.GetEndPoint(i).X;
                            float l12 = (float)intersectionResultArray.get_Item(0).XYZPoint.X;
                            float l21 = (float)line1.GetEndPoint(i).Y;
                            float l22= (float)intersectionResultArray.get_Item(0).XYZPoint.Y;
                            if ((float)line1.GetEndPoint(i).X == (float)intersectionResultArray.get_Item(0).XYZPoint.X && (float)line1.GetEndPoint(i).Y == (float)intersectionResultArray.get_Item(0).XYZPoint.Y)
                            {
                                ...
                                foreach (GeometryObject gobj in geomEle)
                                {
                                    ...
                                    {
                                        if(edge.ApproximateLength>=AllLine.ApproximateLength)
                                        {
                                            Line c = edge.AsCurve() as Line;
                                            if (c.GetEndPoint(0).Z == 0)
                                            {
                                    ...
                                    if(r==null)
                                    {
                                        ...
                                        foreach (Edge edge in edgeArray)
                                        {
                                            if (edge.ApproximateLength>len)
                                            {
                                                Line c = edge.AsCurve() as Line;
                                                if(c.GetEndPoint(0).Z==0)
                                                {
                                                    len = edge.ApproximateLength;
                                                    index = ind;
                                                }
                                            }
                                            ind += 1;
                                        }
                                        referenceArray.Append(edgeArray.get_Item(index).Reference);
                                    }
                                }
                                i += 1;
                                break;
        ...
        //            if (intersectionResultArray != null)
        //            {
        //                GeometryElement geomElem = AllWall.get_Geometry(opt);
        ...
        //                    Face f1 = fArray.get_Item(10);
        //                    EdgeArrayArray eAA = f1.EdgeLoops;
        //                    foreach(EdgeArray eA in eAA)
        //                    {
        //                        Edge e1 = eA.get_Item(0);
        //                        Edge e2 = eA.get_Item(2);
        //                        if (orentation.Y == 1)
        //                        {
        ...
        //                            else
        //                            {
        //                                nR.Append(e1.Reference);
        //                                nR.Append(e2.Reference);
        //                            }
        ...
        //                            else
        //                            {
        //                                eR.Append(e1.Reference);
        //                                eR.Append(e2.Reference);
        //                            }
        ...
        //                            else
        //                            {
        //                                sR.Append(e1.Reference);
        //                                sR.Append(e2.Reference);
        //                            }
        ...
        //                            else
        //                            {
        //                                wR.Append(e1.Reference);
        //                                wR.Append(e2.Reference);
        //                            }
        ...
        //    ReferenceArray sR = new ReferenceArray();
        //    ReferenceArray wR = new ReferenceArray();
        //    Element ff = doc.GetElement(BoundDimension.get_Item(0).get_Item(0).ElementId);
        //    ReferenceArrayArray raa = new ReferenceArrayArray();
        ...
        //                            continue;
        //                        }
        //                        float l1 = (float)edge1.ApproximateLength;
        //                        float l2 = (float)edge1.ApproximateLength;
